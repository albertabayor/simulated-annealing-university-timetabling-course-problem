...
Glover, F., Laguna, M., & Martí, R. (2007). Principles of Tabu Search. In T. F. Gonzalez (Ed.), Handbook of Approximation Algorithms and Metaheuristics (Chapter 23). Taylor & Francis.

Goh, S. L., Kendall, G., & Sabar, N. R. (2017). Simulated annealing with improved reheating and learning for the post enrolment course timetabling problem. Journal of the Operational Research Society, 68(10), 1215-1230. https://doi.org/10.1080/01605682.2017.1391862
...
Kalivas, J. H. (1995). Adaption of simulated annealing to chemical optimization problems. In J. H. Kalivas (Ed.), Optimization of Chemical Processes (pp. 127-158). Elsevier.
...
Muklason, A., Marom, A., & Premananda, I. G. A. (2024). Automated Course Timetabling Optimization Using Tabu-Simulated Annealing Hyper-Heuristics Algorithm. Khazanah Informatika, 10(1), 15-29. https://doi.org/10.4237/ki.v10i1.745

Romaguera, D., Plender-Nabasa, J., Matias, J., & Austero, L. (2023). Development of a Web-based Course Timetabling System based on an Enhanced Genetic Algorithm. Procedia Computer Science, 234, 1714-1721. https://doi.org/10.1016/j.procs.2024.01.166

Soghier, A. A., & Said, L. B. (2021). Adaptive hybrid metaheuristics for course timetabling problems. Journal of Heuristics, 27(4), 563-595. https://doi.org/10.1007/s10732-021-09472-2
...
Xu, Y., Liu, Y., & Zhou, R. (2025). The Impact of Move Schemes on Simulated Annealing Performance. arXiv preprint arXiv:2504.XXXXX. https://arxiv.org/abs/XXXXX
